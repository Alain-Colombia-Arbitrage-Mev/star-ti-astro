...
export const seoData: Record<string, SEOData> = {
  ...
  'hornet-security': {
    ...
    faqJsonLd: faqSchema([
      { q: 'Hornetsecurity funciona solo con Microsoft 365?', a: 'Sí, Hornetsecurity 365 Total Protection esta disenado exclusivamente para Microsoft 365. Se integra nativamente con Exchange Online, OneDrive y SharePoint para protección completa del ecosistema Microsoft.' },
  ...
  proofpoint: {
    ...
    faqJsonLd: faqSchema([
      ...
      { q: 'Cuánto tiempo toma la implementación de Proofpoint?', a: 'La implementación básica toma entre 3 y 5 días habiles. La optimizacion completa, incluyendo ajuste de políticas y modulos avanzados, se completa en 2 a 4 semanas según el tamaño de la organización.' },
  ...
  'stellar-cyber': {
    ...
    faqJsonLd: faqSchema([
      ...
      { q: 'Cuánto tiempo toma el despliegue?', a: 'El despliegue inicial toma entre 1 y 2 semanas gracias a los conectores preconfigurados para más de 400 herramientas y la normalizacion automática de datos.' },
      { q: 'Qué es el motor Multi-Layer AI y como se diferencia del SIEM tradicional?', a: 'Multi-Layer AI es el motor de inteligencia artificial registrado de Stellar Cyber. Combina Detection AI, Correlation AI con GraphML, LLM-Driven AI (AI Investigator) y Agentic AI. A diferencia del SIEM que requiere reglas manuales, Multi-Layer AI correlaciona automaticamente eventos de multiples fuentes y reduce las decisiones del analista a entre 10 y 100 por día.' },
      { q: 'Cómo trabaja Starsolution con Stellar Cyber en Colombia?', a: 'Starsolution implementa e integra la plataforma Stellar Cyber SecOps para clientes en Colombia y la region. Somos su punto de contacto local con soporte tecnico en español, despliegue desde Bogotá y cobertura en Colombia, Venezuela y Miami.' },
    ]),
  },
  'hacking-etico': {
  ...
  sealpath: {
    ...
    description: 'SealPath IRM en Colombia: cifrado persistente, control de acceso granular, revocacion remota y trazabilidad. IRM/E-DRM con integración Microsoft 365 y MIP.',
    ...
    jsonLd: product('SealPath IRM — Information Rights Management', 'SealPath', 'Protección persistente de documentos con cifrado IRM/E-DRM, control de acceso granular, revocacion remota y trazabilidad completa. Integración con Microsoft Information Protection (MIP) y Microsoft 365.', { rating: { value: '4.7', count: '47' }, image: `${BASE_URL}/og-default.png` }),
    faqJsonLd: faqSchema([
  ...
  netwrix: {
    ...
    jsonLd: product('Netwrix — Plataforma de Seguridad de Datos e Identidades', 'Netwrix', 'Plataforma de seguridad de datos centrada en identidad: auditoría AD, PAM, DLP, clasificación de datos, IGA y DSPM para cumplimiento normativo', { rating: { value: '4.7', count: '56' }, image: `${BASE_URL}/og-default.png` }),
    faqJsonLd: faqSchema([
      ...
      { q: 'Cuánto tiempo toma la implementación?', a: 'Para Active Directory y servidores de archivos, la implementación toma entre 2 y 5 días. Un entorno hibrido completo con integraciones en la nube puede tomar entre 2 y 3 semanas. Starsolution gestiona todo el despliegue desde Bogotá con soporte en español.' },
      { q: 'Netwrix puede ayudarme a preparar una auditoría ISO 27001?', a: 'Sí. Netwrix incluye reportes predefinidos mapeados a los controles de ISO 27001 que reducen significativamente el tiempo de preparacion para auditorías de cumplimiento. También cubre GDPR, HIPAA, PCI DSS y, para Colombia, la Ley 1581 y la Circular 007 Superfinanciera.' },
      { q: 'Qué tipo de alertas genera Netwrix?', a: 'Netwrix genera alertas en tiempo real para cambios en grupos administrativos, modificaciones de GPO, acceso masivo a archivos, cambios de permisos en carpetas sensibles y creacion de cuentas privilegiadas, entre otros eventos críticos.' },
      { q: 'Cuál es la diferencia entre Netwrix Auditor y Netwrix Access Analyzer?', a: 'Netwrix Auditor se enfoca en auditoría de cambios y cumplimiento: registra quien modifico que en AD, servidores de archivos y Microsoft 365. Netwrix Access Analyzer es el producto de Data Access Governance y DSPM: descubre y clasifica datos sensibles en 40+ fuentes, monitorea Microsoft Copilot y automatiza la remediación de permisos. Son SKUs distintos que se complementan.' },
  ...
  teamviewer: {
    ...
    description: 'TeamViewer para empresas: acceso remoto seguro, soporte tecnico y gestión IoT. Infraestructura escalable. Licenciamiento oficial Colombia.',
  ...
  anydesk: {
    ...
    jsonLd: product('AnyDesk Enterprise', 'AnyDesk', 'Escritorio remoto ultra rápido a 60 FPS con cifrado militar', { rating: { value: '4.7', count: '73' }, image: `${BASE_URL}/og-default.png` }),
    faqJsonLd: faqSchema([
      { q: 'Es gratis AnyDesk para uso comercial?', a: 'No. El uso comercial requiere licencia de pago. Los planes van desde Professional (EUR 10.90/mes) hasta Power (EUR 20.90/mes) y Ultimate (EUR 52.90/mes). Para más de 1,000 endpoints existe la opcion Enterprise on-premise.' },
  ...
  brother: {
    ...
    faqJsonLd: faqSchema([
      { q: 'Por que elegir Brother sobre otras marcas de impresoras?', a: 'Brother ofrece el menor costo por página del mercado en impresion laser, consumibles de alta duracion (hasta 12,000 páginas), y diseno compacto ideal para oficinas. Además, Brother tiene la tasa de falla mas baja del sector según TechRadar.' },
      { q: 'Starsolution es distribuidor autorizado de Brother?', a: 'Sí. Somos distribuidor autorizado de Brother en Colombia. Esto garantiza productos originales con garantía de fabrica, acceso a precios corporativos y soporte tecnico directo del fabricante.' },
      { q: 'Qué modelos de Brother recomiendan para empresas?', a: 'Para oficinas pequeñas: Brother HL-L2370DW (laser monocromo). Para equipos de trabajo: Brother MFC-L2750DW (multifuncion con escaner y fax). Para alto volumen: Brother MFC-L8900CDW (laser color con ADF duplex de 50 hojas).' },
    ]),
  },
