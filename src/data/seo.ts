...
export const seoData: Record<string, SEOData> = {
  ...
  // =====================================================
  bitdefender: {
    title: 'Distribuidor Bitdefender Colombia | Gold y GravityZone',
    description: '¿Busca distribuidor Gold o #1 de Bitdefender en Colombia? Cotice GravityZone con Starsolution: licencias, implementacion EDR/XDR/MDR y soporte local.',
    keywords: 'distribuidor Bitdefender, distribuidor Bitdefender Colombia, distribuidor Gold Bitdefender Colombia, distribuidor #1 Bitdefender Colombia, Bitdefender Gold partner Colombia, licencias Bitdefender Colombia, comprar Bitdefender empresas, Bitdefender GravityZone Colombia, gravity zone, gravityzone precio, GravityZone EDR XDR, antivirus corporativo empresas, endpoint security, partner Bitdefender Colombia',
    canonical: `${BASE_URL}/bitdefender/`,
    ogTitle: 'Distribuidor Bitdefender Colombia | Gold y GravityZone',
    ogType: 'website',
    ogImage: `${BASE_URL}/og-default.png`,
    ...
    jsonLd: product(
      ...
      'Bitdefender',
      'Licenciamiento e implementacion de Bitdefender GravityZone para empresas en Colombia, con EDR, XDR, Bitdefender MDR (SOC 24x7), CSPM+ y Patch Management. Starsolution opera como partner oficial y distribuidor Bitdefender para empresas, con validacion de nivel de partner cuando el cliente busca Gold o un canal principal.',
    ...
    faqJsonLd: faqSchema([
      ...
      { q: '¿Starsolution es distribuidor Gold de Bitdefender en Colombia?', a: 'Bitdefender maneja niveles Bronze, Silver y Gold dentro de su Partner Advantage Network. Para evitar una afirmacion desactualizada, Starsolution valida el nivel de partner vigente con el fabricante en el momento de la propuesta y acompana el licenciamiento empresarial de GravityZone en Colombia.' },
      { q: '¿Quién es el distribuidor #1 de Bitdefender en Colombia?', a: 'No encontramos un ranking publico vigente de Bitdefender que declare un distribuidor #1 en Colombia. Si su busqueda es comparar al mejor canal para empresas, revise nivel de partner, certificaciones, experiencia de implementacion, soporte local y capacidad de escalamiento. Starsolution cubre esos frentes para licencias GravityZone B2B.' },
  ...
  kaspersky: {
    title: 'Distribuidor Corporativo Kaspersky Colombia | Starsolution',
    description: 'Distribuidor corporativo Kaspersky en Colombia para empresas. Licencias Kaspersky Next, EDR/XDR/MXDR, implementacion, renovacion y soporte en Bogota.',
    keywords: 'distribuidor corporativo Kaspersky Colombia, distribuidor Kaspersky Colombia, partner Kaspersky Colombia, licencias Kaspersky empresas Colombia, Kaspersky Next Colombia, cotizar Kaspersky endpoint Colombia, antivirus corporativo Kaspersky Colombia, Kaspersky EDR Colombia, Kaspersky XDR Colombia, renovar Kaspersky empresas Colombia',
    canonical: `${BASE_URL}/kaspersky/`,
    ogTitle: 'Distribuidor Corporativo Kaspersky Colombia',
    ogType: 'website',
    ogImage: `${BASE_URL}/og-default.png`,
    breadcrumb: [{ name: 'Inicio', url: '/' }, { name: 'Star Protection', url: '/#star-protection' }, { name: 'Kaspersky', url: '/kaspersky/' }],
    jsonLd: product(
      'Kaspersky Next para empresas',
      'Kaspersky',
      'Licenciamiento corporativo e implementacion local de Kaspersky Next en Colombia, con EDR Foundations, EDR Optimum, XDR Optimum, MXDR Optimum, EDR Expert y XDR Expert. Incluye System Watcher anti-ransomware con rollback, EDR, XDR y deteccion gestionada para empresas.',
      { rating: { value: '4.8', count: '94' }, image: `${BASE_URL}/og-default.png` },
    ),
    faqJsonLd: faqSchema([
      { q: '¿Starsolution es distribuidor corporativo Kaspersky en Colombia?', a: 'Si. Starsolution atiende empresas como partner autorizado y distribuidor corporativo Kaspersky en Colombia: cotizamos licencias Kaspersky Next, renovaciones, ampliaciones, implementacion tecnica y soporte en espanol para entornos B2B.' },
  ...
  // =====================================================
  'iso-27001': {
    title: 'Consultoría ISO 27001 Colombia | Cotización SGSI',
    description: 'Consultoría ISO 27001 en Colombia con Starsolution: diagnóstico SGSI, gap analysis, controles Anexo A y preparación para certificación. Cotice gratis.',
    keywords: 'consultoría ISO 27001 Colombia, consultoria ISO 27001 Colombia, consultor ISO 27001 Colombia, certificación ISO 27001, certificación SGSI, auditoría ISO 27001, gap analysis seguridad información, implementación ISO 27001, Anexo A, declaración de aplicabilidad, ISO 27001 Bogotá, ISO 27001 Medellín, ISO 27001 Cali, ISO 27001 precio, cotización ISO 27001',
    canonical: `${BASE_URL}/iso-27001/`,
    ogTitle: 'Consultoría ISO 27001 Colombia | Cotización SGSI',
    ogType: 'website',
    ogImage: `${BASE_URL}/og-default.png`,
      ...
      '@graph': [
        {
          ...
          serviceType: 'Consultoría ISO 27001 y preparación para certificación SGSI',
          url: `${BASE_URL}/iso-27001/`,
          image: `${BASE_URL}/og-default.png`,
          description: 'Consultoría ISO 27001 en Colombia para empresas que necesitan diagnóstico de brechas, implementación del SGSI, controles del Anexo A, auditoría interna y preparación para auditoría externa de certificación.',
          provider: { '@type': 'Organization', '@id': `${BASE_URL}/#organization`, name: 'Starsolution S.A.S.', url: BASE_URL },
          category: 'Information security management consulting',
          areaServed: [
          ...
          offers: {
            '@type': 'Offer',
            name: 'Diagnóstico y cotización de consultoría ISO 27001',
            availability: 'https://schema.org/InStock',
            url: `${BASE_URL}/iso-27001/`,
            priceSpecification: { '@type': 'PriceSpecification', priceCurrency: 'COP', minPrice: 35000000, maxPrice: 150000000 },
          },
          audience: { '@type': 'BusinessAudience', audienceType: 'Empresas en Colombia que buscan certificación ISO 27001' },
          serviceOutput: { '@type': 'Thing', name: 'SGSI ISO/IEC 27001:2022 preparado para auditoría externa de certificación' },
        },
        {
          '@type': 'WebPage',
          '@id': `${BASE_URL}/iso-27001/#webpage`,
          url: `${BASE_URL}/iso-27001/`,
          name: 'Consultoría ISO 27001 Colombia | Cotización SGSI',
          description: 'Consultoría ISO 27001 en Colombia con Starsolution: diagnóstico SGSI, gap analysis, controles Anexo A y preparación para certificación. Cotice gratis.',
          inLanguage: 'es-CO',
  ...
  'mejores-empresas-consultoria-iso-27001-colombia': {
    title: 'Mejores consultoras ISO 27001 Colombia | Guía 2026',
    description: 'Compare empresas de consultoría ISO 27001 en Colombia: Starsolution, firmas SGSI, plataformas GRC y certificadores. Criterios y cotización.',
    keywords: 'mejores empresas de consultoría ISO 27001 Colombia, mejores consultoras ISO 27001 Colombia, empresas consultoría ISO 27001 Colombia, consultores ISO 27001 Colombia, ranking consultoras ISO 27001, certificación ISO 27001 Colombia, SGSI Colombia',
    canonical: `${BASE_URL}/mejores-empresas-consultoria-iso-27001-colombia/`,
    ogTitle: 'Mejores consultoras ISO 27001 Colombia | Guía 2026',
    ogType: 'article',
    ogImage: `${BASE_URL}/assets/seguridad-empresarial-analista.webp`,
    breadcrumb: [
      { name: 'Inicio', url: '/' },
      { name: 'Star Compliance', url: '/#star-compliance' },
      { name: 'ISO 27001', url: '/iso-27001/' },
      { name: 'Mejores consultoras ISO 27001', url: '/mejores-empresas-consultoria-iso-27001-colombia/' },
    ],
    jsonLd: {
      '@context': 'https://schema.org',
      '@graph': [
        {
          '@type': 'WebPage',
          '@id': `${BASE_URL}/mejores-empresas-consultoria-iso-27001-colombia/#webpage`,
          url: `${BASE_URL}/mejores-empresas-consultoria-iso-27001-colombia/`,
          name: 'Mejores consultoras ISO 27001 Colombia | Guía 2026',
          description: 'Guía comparativa para elegir empresas de consultoría ISO 27001 en Colombia, con criterios de compra, shortlist de proveedores y diferenciación entre consultoría y certificación.',
          inLanguage: 'es-CO',
          isPartOf: { '@type': 'WebSite', '@id': `${BASE_URL}/#website`, url: BASE_URL, name: 'Starsolution' },
          about: { '@id': `${BASE_URL}/mejores-empresas-consultoria-iso-27001-colombia/#itemlist` },
          datePublished: '2026-08-18',
          dateModified: '2026-08-18',
        },
        {
          '@type': 'Article',
          '@id': `${BASE_URL}/mejores-empresas-consultoria-iso-27001-colombia/#article`,
          headline: 'Mejores empresas de consultoría ISO 27001 en Colombia',
          description: 'Comparativa editorial de consultoras ISO 27001, plataformas GRC y organismos certificadores para empresas en Colombia.',
          image: `${BASE_URL}/assets/seguridad-empresarial-analista.webp`,
          author: AUTHOR,
          publisher: ORG,
          mainEntityOfPage: { '@id': `${BASE_URL}/mejores-empresas-consultoria-iso-27001-colombia/#webpage` },
          datePublished: '2026-08-18',
          dateModified: '2026-08-18',
        },
        {
          '@type': 'ItemList',
          '@id': `${BASE_URL}/mejores-empresas-consultoria-iso-27001-colombia/#itemlist`,
          name: 'Empresas y opciones de consultoría ISO 27001 en Colombia',
          itemListOrder: 'https://schema.org/ItemListOrderAscending',
          numberOfItems: 8,
          itemListElement: [
            { '@type': 'ListItem', position: 1, item: { '@type': 'Organization', name: 'Starsolution S.A.S.', url: `${BASE_URL}/iso-27001/` } },
            { '@type': 'ListItem', position: 2, item: { '@type': 'Organization', name: 'Infonet Enterprise', url: 'https://www.infonetenterprise.com.co/consultoria-en-iso-27001' } },
            { '@type': 'ListItem', position: 3, item: { '@type': 'Organization', name: 'NSIT S.A.S.', url: 'https://www.nsit.com.co/consultoria-iso-27001/' } },
            { '@type': 'ListItem', position: 4, item: { '@type': 'Organization', name: 'RESE S.A.S.', url: 'https://www.rese.com.co/consultoria-iso-27001-sgsi-bogota-colombia' } },
            { '@type': 'ListItem', position: 5, item: { '@type': 'Organization', name: 'VASCO Solutions', url: 'https://solucionesenlaweb.com/sgsi-iso27001-colombia/' } },
            { '@type': 'ListItem', position: 6, item: { '@type': 'Organization', name: 'Hackmetrix', url: 'https://www.hackmetrix.com/' } },
            { '@type': 'ListItem', position: 7, item: { '@type': 'Organization', name: 'Delta Protect', url: 'https://www.deltaprotect.com/soluciones/consultoria-iso-27001-para-empresas' } },
            { '@type': 'ListItem', position: 8, item: { '@type': 'Organization', name: '27001.com.co', url: 'https://27001.com.co/' } },
          ],
        },
      ],
    },
    faqJsonLd: faqSchema([
      {
        q: '¿Cuáles son las mejores empresas de consultoría ISO 27001 en Colombia?',
        a: 'Las mejores opciones dependen del tipo de proyecto. Para empresas que necesitan consultoría ISO 27001 con ciberseguridad empresarial, Starsolution es una opción fuerte. También puede comparar firmas como Infonet Enterprise, NSIT, RESE, VASCO Solutions y opciones tipo plataforma como Hackmetrix o Delta Protect.',
      },
      {
        q: '¿Una certificadora ISO 27001 también puede ser mi consultora?',
        a: 'Lo recomendable es separar roles. La consultora prepara el SGSI, riesgos, controles y evidencias; el organismo certificador audita de forma independiente y emite el certificado si el sistema cumple los requisitos.',
      },
      {
        q: '¿Qué debe incluir una propuesta de consultoría ISO 27001?',
        a: 'Debe incluir diagnóstico de brechas, alcance del SGSI, análisis de riesgos, Declaración de Aplicabilidad, controles del Anexo A, auditoría interna, preparación para auditoría externa, cronograma, responsables y precio claro.',
      },
      {
        q: '¿Cuál es la mejor consultora ISO 27001 para empresas medianas en Colombia?',
        a: 'Para una empresa mediana, conviene elegir una consultora que combine cumplimiento y seguridad técnica. Si la empresa necesita demostrar controles ante clientes corporativos, Starsolution puede acompañar desde el diagnóstico hasta la preparación de auditoría externa.',
      },
      {
        q: '¿Cómo evitar contratar una consultoría ISO 27001 genérica?',
        a: 'Pida ejemplos de entregables, metodología, experiencia sectorial, rol del consultor líder, plan de auditoría interna y evidencia de cómo adaptan los controles al negocio. Desconfíe de propuestas basadas solo en plantillas documentales.',
      },
    ]),
  },
  sealpath: {
  ...
  'seguridad-informatica-empresas': {
    title: 'Seguridad Informática Empresarial | Defensa Ransomware',
    description: 'Seguridad informática empresarial en Colombia con defensa contra ransomware: EDR/XDR, correo seguro, backups, monitoreo 24/7 y respuesta a incidentes.',
    keywords: 'seguridad informática empresarial, defensa ransomware empresas, seguridad informática empresas Colombia, protección ransomware Colombia, EDR XDR empresas, respuesta ransomware',
    canonical: `${BASE_URL}/seguridad-informatica-empresas/`,
    ogTitle: 'Seguridad Informática Empresarial contra Ransomware',
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/seguridad-empresarial-soc.webp`,
    breadcrumb: [{ name: 'Inicio', url: '/' }, { name: 'Seguridad Informática', url: '/seguridad-informatica-empresas/' }],
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'Seguridad Informática Empresarial contra Ransomware',
      description: 'Programa de seguridad informática empresarial con EDR/XDR, protección de correo, backups, monitoreo 24/7, gestión de vulnerabilidades y respuesta a incidentes de ransomware.',
      provider: ORG,
      serviceType: 'Enterprise Cybersecurity and Ransomware Defense',
      areaServed: { '@type': 'Country', name: 'Colombia' },
      image: `${BASE_URL}/assets/seguridad-empresarial-soc.webp`,
      url: `${BASE_URL}/seguridad-informatica-empresas/`,
      audience: { '@type': 'BusinessAudience', audienceType: 'Empresas, pymes, entidades reguladas y equipos de tecnología' },
      hasOfferCatalog: {
        '@type': 'OfferCatalog',
        name: 'Servicios de defensa anti-ransomware',
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Diagnóstico de riesgo ransomware' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Implementación EDR/XDR administrada' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Respuesta a incidentes de ransomware' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Diseño de estrategia de backups resilientes' } },
        ],
      },
    },
    faqJsonLd: faqSchema([
      { q: '¿Qué incluye una estrategia de seguridad informática empresarial contra ransomware?', a: 'Incluye protección EDR/XDR en endpoints y servidores, seguridad de correo, MFA, gestión de vulnerabilidades, backup 3-2-1-1, monitoreo continuo, plan de respuesta a incidentes y pruebas periódicas de restauración.' },
      { q: '¿Por dónde debe empezar una empresa si hoy no tiene defensa anti-ransomware?', a: 'El primer paso es un diagnóstico de activos, backups, accesos remotos, correo y privilegios. Luego se priorizan controles de alto impacto: MFA, EDR administrado, cierre de RDP/VPN expuestos, backups probados y protección de email.' },
      { q: '¿Un antivirus tradicional es suficiente para detener ransomware?', a: 'No. El ransomware moderno usa credenciales válidas, herramientas administrativas y técnicas de evasión. Una empresa necesita EDR/XDR con monitoreo de comportamiento, capacidad de aislamiento y respuesta operada por especialistas.' },
      { q: '¿Cada cuánto se deben probar los backups?', a: 'Para sistemas críticos, la prueba debe hacerse como mínimo cada trimestre y después de cambios relevantes de infraestructura. La prueba debe medir tiempo real de restauración, integridad de datos y orden de recuperación.' },
      { q: '¿Starsolution puede ayudar si la empresa ya fue atacada?', a: 'Sí. El trabajo inicial es contener la propagación, preservar evidencia, evaluar alcance, cerrar el vector de entrada y definir si la recuperación desde backups es viable antes de restaurar sistemas.' },
    ]),
  },
  'antivirus-empresas': {
  ...
  // =====================================================
  venezuela: {
    title: 'Empresa de Ciberseguridad en Venezuela | Starsolution',
    description: 'Servicios de ciberseguridad para empresas en Venezuela: EDR/XDR, hacking ético, ISO 27001 y SOC 24/7. Oficina en Caracas, facturación en USD. Cotice gratis.',
    keywords: 'empresa de ciberseguridad Venezuela, servicios de ciberseguridad Caracas, ciberseguridad empresarial Venezuela, hacking ético Venezuela, ISO 27001 Venezuela, antivirus empresas Caracas',
    canonical: `${BASE_URL}/venezuela/`,
    ogTitle: 'Starsolution Venezuela — Empresa de Ciberseguridad en Caracas',
    ogType: 'website',
    ogImage: `${BASE_URL}/og-default.png`,
    hreflang: HREFLANG_HOME,
    ...
    jsonLd: {
      ...
      '@id': `${BASE_URL}/venezuela/#localbusiness`,
      name: 'Starsolution Venezuela',
      description: 'Empresa de ciberseguridad y soluciones tecnológicas para empresas en Venezuela',
  ...
  miami: {
    title: 'Cybersecurity Company Miami & South Florida | Starsolution',
    description: 'Managed cybersecurity services in Miami and South Florida: EDR/XDR, penetration testing, HIPAA & SOC 2 compliance. Bilingual team, free assessment.',
    keywords: 'cybersecurity company Miami, managed cybersecurity services South Florida, MSSP Miami, penetration testing Miami, HIPAA compliance Florida, ISO 27001 Florida',
    canonical: `${BASE_URL}/miami/`,
    ogTitle: 'Starsolution Florida — Cybersecurity Company in Miami & South Florida',
    ogType: 'website',
    ogImage: `${BASE_URL}/og-default.png`,
    lang: 'en',
    hreflang: HREFLANG_HOME,
    ...
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'ProfessionalService',
      '@id': `${BASE_URL}/miami/#localbusiness`,
      name: 'Starsolution Florida',
      description: 'Managed cybersecurity and IT security services across Florida, serving Miami and South Florida from our Orlando office',
      url: `${BASE_URL}/miami/`,
      image: `${BASE_URL}/og-default.png`,
  ...
  'blog/comprar-kaspersky-empresas-colombia': {
    title: 'Comprar Kaspersky Empresas Colombia | Guia B2B',
    description: 'Como comprar Kaspersky para empresas en Colombia: distribuidor corporativo, licencias Kaspersky Next, renovaciones, implementacion y soporte local.',
    keywords: 'comprar Kaspersky empresas Colombia, distribuidor corporativo Kaspersky Colombia, licencias Kaspersky Next Colombia, partner Kaspersky Colombia, renovar Kaspersky empresas',
    canonical: `${BASE_URL}/blog/comprar-kaspersky-empresas-colombia/`,
    ogTitle: 'Como comprar Kaspersky para empresas en Colombia',
    ogType: 'article',
    ogImage: `${BASE_URL}/assets/hero-ciberseguridad-infraestructura.webp`,
    breadcrumb: [{ name: 'Inicio', url: '/' }, { name: 'Blog', url: '/#blog' }, { name: 'Comprar Kaspersky Empresas Colombia', url: '/blog/comprar-kaspersky-empresas-colombia/' }],
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'Article',
      headline: 'Como comprar Kaspersky para empresas en Colombia',
      description: 'Guia B2B para comprar licencias Kaspersky Next en Colombia con un distribuidor corporativo, incluyendo pasos, criterios de seleccion y enlaces oficiales.',
      datePublished: '2026-08-18',
      dateModified: '2026-08-18',
      author: AUTHOR,
      publisher: { '@type': 'Organization', name: 'Starsolution S.A.S.', url: BASE_URL, logo: { '@type': 'ImageObject', url: `${BASE_URL}/logo.png` } },
      image: `${BASE_URL}/assets/hero-ciberseguridad-infraestructura.webp`,
      url: `${BASE_URL}/blog/comprar-kaspersky-empresas-colombia/`,
      about: { '@type': 'Thing', name: 'Kaspersky Next para empresas' },
      keywords: 'comprar Kaspersky empresas Colombia, distribuidor Kaspersky, licencias Kaspersky Next',
    },
    faqJsonLd: faqSchema([
      { q: '¿Donde comprar Kaspersky para empresas en Colombia?', a: 'Una empresa en Colombia debe comprar Kaspersky a traves de un partner o distribuidor corporativo que pueda cotizar licencias, renovar contratos, recomendar la edicion adecuada e implementar la consola. Starsolution atiende ese proceso para entornos B2B con soporte local en espanol.' },
      { q: '¿Que datos necesito para cotizar Kaspersky Next?', a: 'Para cotizar Kaspersky Next se necesita numero de endpoints, servidores, usuarios moviles, sedes, edicion requerida, plazo de licencia, antivirus actual y si la empresa necesita EDR, XDR o MXDR. Con esos datos se evita comprar una edicion insuficiente o sobredimensionada.' },
      { q: '¿Kaspersky se compra directo o por partner?', a: 'Kaspersky ofrece canales comerciales y programas de partners para venta, implementacion y soporte. Para empresas, trabajar con un distribuidor corporativo reduce friccion porque integra cotizacion, despliegue, capacitacion, renovacion y escalamiento tecnico.' },
    ]),
  },

  'blog/kaspersky-next-precio-colombia': {
    title: 'Precio Kaspersky Next Colombia | Cotizacion Empresas',
    description: 'Factores que definen el precio de Kaspersky Next en Colombia: endpoints, edicion EDR/XDR/MXDR, plazo, renovacion, soporte e implementacion.',
    keywords: 'precio Kaspersky Next Colombia, cotizacion Kaspersky empresas, cuanto cuesta Kaspersky endpoint Colombia, Kaspersky EDR precio Colombia, renovar Kaspersky Colombia',
    canonical: `${BASE_URL}/blog/kaspersky-next-precio-colombia/`,
    ogTitle: 'Precio de Kaspersky Next en Colombia para empresas',
    ogType: 'article',
    ogImage: `${BASE_URL}/assets/icono-escudo-tecnologico.webp`,
    breadcrumb: [{ name: 'Inicio', url: '/' }, { name: 'Blog', url: '/#blog' }, { name: 'Precio Kaspersky Next Colombia', url: '/blog/kaspersky-next-precio-colombia/' }],
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'Article',
      headline: 'Precio de Kaspersky Next en Colombia para empresas',
      description: 'Guia para entender como se calcula una cotizacion corporativa de Kaspersky Next en Colombia y que variables afectan el precio final.',
      datePublished: '2026-08-18',
      dateModified: '2026-08-18',
      author: AUTHOR,
      publisher: { '@type': 'Organization', name: 'Starsolution S.A.S.', url: BASE_URL, logo: { '@type': 'ImageObject', url: `${BASE_URL}/logo.png` } },
      image: `${BASE_URL}/assets/icono-escudo-tecnologico.webp`,
      url: `${BASE_URL}/blog/kaspersky-next-precio-colombia/`,
      about: { '@type': 'Thing', name: 'Precio Kaspersky Next Colombia' },
      keywords: 'precio Kaspersky Next Colombia, cotizacion Kaspersky, licencias Kaspersky empresas',
    },
    faqJsonLd: faqSchema([
      { q: '¿Cuanto cuesta Kaspersky Next en Colombia?', a: 'El precio de Kaspersky Next en Colombia depende de la edicion, numero de endpoints, servidores, plazo de licencia, renovacion o compra nueva, soporte requerido y alcance de implementacion. Por eso la cotizacion corporativa se calcula caso por caso.' },
      { q: '¿Que edicion de Kaspersky suele costar mas?', a: 'Las ediciones con XDR, MXDR o capacidades Expert suelen costar mas que EDR Foundations porque agregan correlacion entre capas, investigacion avanzada, respuesta gestionada o capacidades de SOC. La decision debe basarse en riesgo, no solo en precio unitario.' },
      { q: '¿La implementacion esta incluida en la licencia?', a: 'La licencia cubre el derecho de uso del software, pero la implementacion puede variar segun el distribuidor. En Starsolution la cotizacion puede incluir configuracion de consola, politicas, despliegue por grupos, capacitacion y soporte.' },
    ]),
  },

  'blog/kaspersky-edr-xdr-mxdr-colombia': {
    title: 'Kaspersky EDR vs XDR vs MXDR Colombia | Guia',
    description: 'Diferencias entre Kaspersky EDR, XDR y MXDR para empresas en Colombia. Compare visibilidad, respuesta, SOC, costo operativo y casos de uso.',
    keywords: 'Kaspersky EDR vs XDR, Kaspersky MXDR Colombia, Kaspersky Next EDR Optimum, Kaspersky XDR Colombia, Kaspersky SOC gestionado',
    canonical: `${BASE_URL}/blog/kaspersky-edr-xdr-mxdr-colombia/`,
    ogTitle: 'Kaspersky EDR vs XDR vs MXDR para empresas en Colombia',
    ogType: 'article',
    ogImage: `${BASE_URL}/assets/robot-ia-laboratorio-monitores.webp`,
    breadcrumb: [{ name: 'Inicio', url: '/' }, { name: 'Blog', url: '/#blog' }, { name: 'Kaspersky EDR vs XDR vs MXDR', url: '/blog/kaspersky-edr-xdr-mxdr-colombia/' }],
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'Article',
      headline: 'Kaspersky EDR vs XDR vs MXDR para empresas en Colombia',
      description: 'Comparativa practica entre Kaspersky EDR, XDR y MXDR para decidir que nivel de Kaspersky Next necesita una empresa colombiana.',
      datePublished: '2026-08-18',
      dateModified: '2026-08-18',
      author: AUTHOR,
      publisher: { '@type': 'Organization', name: 'Starsolution S.A.S.', url: BASE_URL, logo: { '@type': 'ImageObject', url: `${BASE_URL}/logo.png` } },
      image: `${BASE_URL}/assets/robot-ia-laboratorio-monitores.webp`,
      url: `${BASE_URL}/blog/kaspersky-edr-xdr-mxdr-colombia/`,
      about: { '@type': 'Thing', name: 'Kaspersky EDR XDR MXDR' },
      keywords: 'Kaspersky EDR, Kaspersky XDR, Kaspersky MXDR, Kaspersky Next Colombia',
    },
    faqJsonLd: faqSchema([
      { q: '¿Cual es la diferencia entre Kaspersky EDR y XDR?', a: 'Kaspersky EDR se enfoca en deteccion, investigacion y respuesta sobre endpoints. Kaspersky XDR amplía la visibilidad a multiples capas, como endpoint, identidad, correo, nube e integraciones, para correlacionar senales y acelerar la respuesta.' },
      { q: '¿Cuando conviene Kaspersky MXDR?', a: 'Kaspersky MXDR conviene cuando la empresa necesita monitoreo y respuesta gestionada, pero no tiene un SOC interno 24/7. Es util para organizaciones con alto riesgo, operacion continua o equipos de TI pequenos frente a amenazas avanzadas.' },
      { q: '¿Puedo empezar con EDR y luego pasar a XDR?', a: 'Si. La linea Kaspersky Next esta organizada por niveles, de endpoint y EDR hasta XDR y MXDR. La ruta recomendada es iniciar con la visibilidad que el equipo pueda operar y escalar cuando aumente la madurez o el riesgo.' },
    ]),
  },
