...
export const seoData: Record<string, SEOData> = {
  ...
  kaspersky: {
    ...
    faqJsonLd: faqSchema([
      ...
      { q: 'Puedo gestionar dispositivos moviles (Android/iOS) desde la misma consola?', a: 'Si. Kaspersky Next incluye MDM integrado. Puede aplicar politicas de seguridad, borrado remoto, geolocalizacion y contenedorizacion de datos corporativos en smartphones y tablets desde la misma interfaz que gestiona PCs y servidores.' },
      { q: 'Que tan complicado es migrar desde nuestro antivirus actual?', a: 'El proceso tipico toma menos de una semana para empresas de hasta 500 endpoints. Starsolution maneja auditoria, configuracion de la consola cloud, desinstalacion automatica del antivirus anterior mediante scripts y despliegue silencioso de Kaspersky por GPO o instaladores remotos. Los usuarios finales generalmente no notan el cambio.' },
      { q: 'Afecta el rendimiento de equipos antiguos o de bajos recursos?', a: 'Kaspersky esta optimizado para consumo minimo de recursos. En equipos con Core i3 o superiores y 4 GB RAM el impacto es menor al 2 por ciento de CPU en operacion normal. Para equipos legacy podemos programar escaneos fuera de horario y desactivar modulos no criticos.' },
    ]),
  },
  'hornet-security': {
